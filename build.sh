...
FetchWebDev() {
  curl -L https://codeload.github.com/gxcnm/web-dist/tar.gz/refs/heads/dev -o web-dist-dev.tar.gz
...
FetchWebRelease() {
  curl -L https://github.com/gxcnm/alist-web/releases/latest/download/dist.tar.gz -o dist.tar.gz
